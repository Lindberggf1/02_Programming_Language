...
namespace WebVendas.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            if (_context.Department.Any() ||   // testar se tem algum resgistro na base de dados.
                _context.Seller.Any() ||
            ...
            /// criar os objetos para popular as tabelas
            /// Departamentos
            ...
            /// vamos adicionar eles agora no banco de dados 
            ...
            _context.SaveChanges(); /// salvando e confirmando no banco de dados.
        }
    }
}
